...
Auditing the multi-species intrinsically disordered protein dataset (`val.tsv` raw $n=697$, SHA-256 `b7ef171d...`; `train.tsv` raw $n=2554$, 3,546 KB, SHA-256 `ecda4a8b...`, constructed by joining PhaSepDB `PSID` records; You et al., 2020 and LLPSDB `LLPS` entry headers; Li et al., 2020) revealed a diverse species distribution (Validation denominator $n=656$: 71.19% *Homo sapiens*, 28.81% across 17 model organisms including *S. cerevisiae*, *X. laevis*, *D. melanogaster*, *M. musculus*; Training denominator $n=2539$: 51.00% *Homo sapiens*, 49.00% across 32 model organisms including SARS-CoV-2 9.97%, *E. coli* 4.81%, *C. elegans* 4.14%, Yeast 3.66%).

Applying unified sequence extraction and strict missing string (`"UNKNOWN"`) filtering (excluding 41 rows in validation and 15 rows in training) yielded consistent sequence length bias across both splits:
...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Validation Split (`val.tsv`)** | Pure AA Sequence Length | $656$ | $441$ ($67.2\%$) | $215$ ($32.8\%$) | **`0.6017`** | `[0.5569, 0.6465]` (SE = $0.0229$) | **Statistically Significant** |
...
| **Validation Split (`val.tsv`)** | FASTA Header Text Length | $656$ | $441$ ($67.2\%$) | $215$ ($32.8\%$) | **`0.5762`** | `[0.5306, 0.6218]` (SE = $0.0232$) | **Statistically Significant** |
| **Validation Split (`val.tsv`)** | Missing Sequence Indicator | $697$ | $465$ ($66.7\%$) | $232$ ($33.3\%$) | **`0.4892`** | `[0.4436, 0.5348]` (SE = $0.0232$) | Uninformative Noise ($0.50 \in \text{CI}$) |
| **Training Split (`train.tsv`)** | Pure AA Sequence Length | $2539$ | $1734$ ($68.3\%$) | $805$ ($31.7\%$) | **`0.6010`** | `[0.5781, 0.6239]` (SE = $0.0117$) | **Statistically Significant** |

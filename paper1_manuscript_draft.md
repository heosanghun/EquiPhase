...
2. **Locked-Specification Implementation Deviation (Pattern 11)**: While the preregistration specification required Implicit Function Theorem (IFT) exact analytical backpropagation, the actual code unrolled 100 forward solver iterations into the autograd computation graph.
